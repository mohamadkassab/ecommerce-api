...
namespace ecommerce_dash_api.Services
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(IProductRepository productRepository, ISetupRepository setupRepository, EcommerceContext context, IHelpersFunctions helpersFunctions)
        {
        ...
        public async Task<List<byte[]>> GetProductMediaAsync(int productId)
        {
            ...
            {
                mediaList.Add(_helpersFunctions.GetFileByUrl(mediaUrl));
            }
            return mediaList;
        }
